...
function About() {
  return (
    <div id='aboutMe' className='h-[100vh] max-w-[1644px] mx-auto bg-[#15223a] text-white py-12'>
      ...
      <div className='about--section pt-32 relative'>
        <div className='left--side ml-12 flex flex-col gap-6'>
          ...
          <p className='w-1/3'>I'm Alfaz Hosain. I am a <span className='text-[#29cfd5]'>#Freelance</span> <span className='text-[#29cfd5]'>  #Fullstack #Developer.</span> And I am also a Blockchain enthusiast. I have serious Interest in <span className='text-[#29cfd5]'>#Blockchain.</span>  </p>
