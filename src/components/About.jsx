    ...
    <div id='aboutMe' className='h-[100vh] max-w-[1644px] mx-auto bg-slate-900  text-white py-12'>
      ...
      <div className='about--section pt-32 relative'>
        <div className='left--side ml-12 max-sm:m-0 flex flex-col gap-6'>
          ...
          <p className='w-1/3 max-sm:w-full font-Regular max-sm:text-center'>I'm Alfaz Hosain. I am a <span className='text-[#29cfd5]'>#Freelance</span> <span className='text-[#29cfd5]'>  #Fullstack #Developer.</span> And I am also a Blockchain enthusiast. I have serious Interest in <span className='text-[#29cfd5]'>#Blockchain.</span>  </p>
        ...
        <div className='right--side justify-center max-sm:hidden '>
            <img className='absolute mr-12 right-4 top-10 max-lg:w-[400px] w-[550px] shadow-[#29cfd5] shadow-lg rounded-full' src={banner} alt="" srcset="" />
        </div>
      </div>
    </div>
  )
